...
# 后台IP设置
export Ipv4_ipaddr="10.10.10.254"            # 修改openwrt后台地址(填0为关闭)
...
# 旁路由选项
export Gateway_Settings="10.10.10.252"                 # 旁路由设置 IPv4 网关(填入您的网关IP为启用)(填0为不作修改)
export DNS_Settings="10.10.10.252"                     # 旁路由设置 DNS(填入DNS，多个DNS要用空格分开)(填0为不作修改)
